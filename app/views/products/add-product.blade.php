...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="available_quantity" name="short_desc" placeholder="AVAILABLE DESC" class="form-control input-md"  type="text">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="product_weight" name="detail" placeholder="PRODUCT DETAIL" class="form-control input-md" type="text">
