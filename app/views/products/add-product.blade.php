...
@section('content')
<form action="{{ BASE_URL . 'save-add'}}" method="post" onsubmit="return validate()"class="form-horizontal" enctype="multipart/form-data">
  <fieldset>
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      <input id="image-product" name="image" class="input-file" type="file">
...
<script type="text/javascript">
 ...
 var check_cate = document.getElementById("product_categorie");
 ...
 function validate()
 {
  ...
  if (check_cate.value == "") 
  {
    check_cate.style.border = "1px solid red";
    cate_err.innerHTML = "Vui lòng nhập tên danh mục";
    cate_err.style.color ="red";
    return false;
  }
  ...
  // check_name.addEventListener('blur',function() {
  //   if (check_name.value != "") {
  //     check_name.style.border = "1px solid #ccc";
  //     name_err.innerHTML = "";
  //   }
  // },true);
